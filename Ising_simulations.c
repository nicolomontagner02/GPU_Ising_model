...
int main(int argc, char *argv[])
{
       ...
       printf("========================================\n");
       printf("2D Ising Model — GPU_1D_block\n");
       printf("========================================\n");
       printf("Lattice size        : %d x %d\n", lattice_size_x, lattice_size_y);
       printf("Interaction J       : %.3f\n", J);
       printf("External field h    : %.3f\n", h);
       ...
       Observables out3 = run_ising_simulation_1D_block_gpu(lattice_size_x, lattice_size_y, type, J, h, kB, T, n_steps);
       ...
       printf("========================================\n");
       printf("2D Ising Model — GPU_2D_block\n");
       printf("========================================\n");
       printf("Lattice size        : %d x %d\n", lattice_size_x, lattice_size_y);
       printf("Interaction J       : %.3f\n", J);
       printf("External field h    : %.3f\n", h);
       ...
       Observables out4 = run_ising_simulation_2D_block_gpu(lattice_size_x, lattice_size_y, type, J, h, kB, T, n_steps);
